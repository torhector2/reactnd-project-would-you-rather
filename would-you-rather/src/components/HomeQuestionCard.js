...
class HomeQuestionCard extends Component {
    render() {
        ...
        return(
            <li key={question.id}>
                <div className="h-56 w-full max-w-full flex mt-8 mb-8 hover:bg-blue-100">
                    ...
                    <div className="my-12 ml-4 w-1/4">
                        ...
                        <Link to={`/questions/${question.id}`}>
                            <div className="mt-6 bg-blue-500 hover:bg-blue-700 text-center text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">View Poll</div>
                        </Link>
                    </div>
                </div>
            </li>
